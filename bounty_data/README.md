...
*the gen params in `bounty_test.cpp` are made with a small security gap (prf_delta) to create conditions for hypergraph and syndrome analysis*
...
2. tell us the parameters you managed to collect and how to calculate them.

3. no rules beyond cryptanalysis (any valid attack wins)
